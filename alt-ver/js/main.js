...
// BONUS: "Fizz", "Buzz" and "FizzBuzz" have a different color from one another
...
for (var i = 1; i < 101; ++i)
{
    if (i % 3 === 0 && i % 5 === 0) fizzBuzzUl.innerHTML += 
        "<li style=\"color: red\">FizzBuzz</li>";
    else if (i % 3 === 0) fizzBuzzUl.innerHTML += "<li style=\"color: blue\">Fizz</li>";
    else if (i % 5 === 0) fizzBuzzUl.innerHTML += "<li style=\"color: green\">Buzz</li>";
